...
function init() {
    DOM.productsPaylod.productNameRef = document.querySelector("#yourNotes");
    DOM.productsPaylod.price = document.querySelector("#year");
    DOM.productsPaylod.image = document.querySelector("#time");
